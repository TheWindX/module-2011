...
//	}
	...
	u32 st_vm_cor::c_pop_global(u32 gid, st_code* pc)
	{
		//ns_util::st_var* var = m_symbols.find_name(name);
		//assert(var->m_type == e_global);
		//u32 idx = var->g.path->get_id();
		st_code c = st_c_pop_global::make(gid);
