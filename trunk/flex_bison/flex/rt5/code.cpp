...
namespace ns_core
{
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_push_local>::instance().m_tag;
		ret.set(local_idx);
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_pop_local>::instance().m_tag;
		ret.set(local_idx);
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_push_ref>::instance().m_tag;
		ret.set(local_idx);
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_pop_ref>::instance().m_tag;
		ret.set(local_idx);
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_push_global>::instance().m_tag;
		ret.set(idx);
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_pop_global>::instance().m_tag;
		ret.set(idx);
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_push_bool>::instance().m_tag;
		ret.m_num = b;
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_push_int>::instance().m_tag;
		ret.m_num = num;
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_push_string>::instance().m_tag;
	...
	st_code st_c_push_function::make(u32 code_idx, u32 ins, u32 locs)
	{
		...
		st_code ret;
		ret.m_tag = st_singleton<st_c_push_function>::instance().m_tag;
		ret.m_val = f;
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_goto>::instance().m_tag;
		ret.set(code_idx);
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_goto_true>::instance().m_tag;
		ret.set(code_idx);
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_goto_false>::instance().m_tag;
		ret.set(code_idx);
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_apply_begin>::instance().m_tag;
		return ret;
	}
	...
	void st_c_apply::run(void* opr, st_vm* rt)
	{
		st_value v = rt->get_eval(-1);
		rt->m_evals.pop();
		if(v.m_tag == ns_util::st_singleton<st_v_primary_function>::instance().m_tag)
		{	
			f_proto pf = v.get<f_proto>();
			rt->apply_primary(pf);
		}
		else if(v.m_tag == ns_util::st_singleton<st_v_function>::instance().m_tag)
		{
	...
	{
		st_code code;
		code.m_tag = st_singleton<st_c_apply>::instance().m_tag;
		return code;
	}
	...
	{
		st_code code;
		code.m_tag = st_singleton<st_c_apply_instant>::instance().m_tag;
		return code;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_ret_begin>::instance().m_tag;
		return ret;
	}
	...
	{
		st_code ret;
		ret.m_tag = st_singleton<st_c_ret>::instance().m_tag;
		ret.set<bool>(byield);
		return ret;
	}
