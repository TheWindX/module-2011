...
namespace ns_core
{	
	void st_ast_cons::set_vm_cons(st_vm_cons* vm_cons)
	{
		m_vm_cons = vm_cons;
	}

	void st_ast_cons::clean()
	{
		m_p_values.clear();
		m_vm_cons->m_symbols.clean();
	}

	st_ast* st_ast_cons::get_p_value(s32 index)
	{
		if(index < 0)
		{
	...
	void st_ast_cons::push_p_value(st_ast* v)
	{
		m_p_values.push(v);
	}

	void st_ast_cons::pop_p_value(u32 num)
	{
		for(u32 i = 0; i<num; ++i)
		{
			m_p_values.pop();
	...
	void st_ast_cons::p_export()
	{
		...
		for(u32 i = 0; i<sz; ++i)
		{
			...
			bool b = m_vm_cons->m_symbols.export_symbol(cstr);
			ns_core::st_sym_var* var = m_vm_cons->m_symbols.reg_name(cstr);

			u32 idx = var->g.path->get_id();
			if(idx >= m_vm_cons->m_globals.size() ) m_vm_cons->m_globals.resize(idx+1);
		}
		pop_p_value(1);
	};

	void st_ast_cons::p_null_path()
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_string(const char* str)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_var(bool is_extern)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_new_var_list()
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_assign(u32 l, u32 r)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_unitop(const char* op)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_binop(const char* op, u32 l, u32 r)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_bool(bool b)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_number(u32 num, u32 l, u32 r)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_quot_string(const char* s)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_null_para_list()
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_apply(u32 l, u32 r)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_enter()
	{
#ifdef _AST_DEBUG
		std::cout<<"enter"<<std::endl;
#endif
		m_vm_cons->m_symbols.enter();
	};

	void st_ast_cons::p_exit(u32 l, u32 r)
	{
#ifdef _AST_DEBUG
		...
		//m_ctx->m_symbol.exit();
		m_vm_cons->m_symbols.exit();
	};

	void st_ast_cons::p_return(bool byield)//TODO
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_for_condition()
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_for_stats(u32 l, u32 r)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_self_op(bool add_or_sub, bool pre_or_post)
	{
#ifdef _AST_DEBUG
	...
	void st_ast_cons::p_break()
	{
#ifdef _AST_DEBUG
		std::cout<<"break"<<std::endl;
#endif
		st_break* ret = new st_break;
		push_p_value(ret);	
	}

	void st_ast_cons::p_continue()
	{
#ifdef _AST_DEBUG
		std::cout<<"continue"<<std::endl;
#endif
		st_continue* ret = new st_continue;
		push_p_value(ret);	
	}
