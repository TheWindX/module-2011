...
namespace ns_core
{
	...
	struct st_v_null : public i_value_proto
	{
		...
		{
			st_value ret;
			ret.m_tag = st_singleton<st_v_null>::instance().m_tag;
			return ret;
		}
	};
	...
	struct st_v_bool : public i_value_proto
	{
		...
		static st_value make_value(bool b)
		{
			st_value ret;
			ret.m_num = b;
			ret.m_tag = st_singleton<st_v_bool>::instance().m_tag;
			return ret;
		}
	};
	...
	struct st_v_int : public i_value_proto
	{
		...
		static st_value make_value(s32 val)
		{
			st_value ret;
			ret.m_num = val;
			ret.m_tag = st_singleton<st_v_int>::instance().m_tag;
			return ret;
		}
	};
	...
	struct st_v_string : public i_value_proto
	{
		...
		static st_value make_value(const char* val)
		{
			...
			ret.m_tag = st_singleton<st_v_string>::instance().m_tag;
			return ret;
		}
	...
	struct st_v_ref : public i_value_proto
	{
		...
		static st_value make_value()
		{
			...
			st_value ret;
			ret.m_tag = st_singleton<st_v_ref>::instance().m_tag;
			ret.m_val = pv;
			return ret;
		}
	...
	struct st_v_function : public i_value_proto
	{
		...
		{	
			...
			ret.m_tag = st_singleton<st_v_function>::instance().m_tag;
			return ret;
		}
	};
	...
	struct st_v_primary_function : public i_value_proto
	{
		...
		static st_value make_value(f_proto func)
		{
			st_value ret;
			ret.m_val = func;
			ret.m_tag = st_singleton<st_v_primary_function>::instance().m_tag;
			return ret;
		}
	};
	...
	struct st_v_array : public i_value_proto
	{
		...
		static st_value make_value()
		{
			...
			ret.m_tag = st_singleton<st_v_array>::instance().m_tag;
			return ret;
		}
		const char* to_string(st_value, st_vm*);
	};
	...
	struct st_v_map : public i_value_proto
	{
		...
		static st_value make_value(st_vm* vm)
		{
			...
			ret.m_tag = st_singleton<st_v_map>::instance().m_tag;//TODO 1.需要定制st_value的比较函数, 2. 将来采用hash,
			return ret;
		}
		const char* to_string(st_value, st_vm*);
	};
